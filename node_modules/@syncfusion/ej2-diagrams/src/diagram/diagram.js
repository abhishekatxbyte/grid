...
var Diagram = /** @class */ (function (_super) {
    ...
    Diagram.prototype.onPropertyChanged = function (newProp, oldProp) {
        ...
        if (this.rotateUsingButton && !this.fromUndo) {
                    ...
                    if (this.rotateUsingButton) {
                        ...
                        for (var _k = 0, _l = Object.keys(newProp.nodes); _k < _l.length; _k++) {
                            ...
                            if (newProp.nodes[parseInt(nodeIndex.toString(), 10)].rotateAngle !== undefined) {
                                ...
                                oldProp.nodes[parseInt(nodeIndex.toString(), 10)] = { rotateAngle: newProp.nodes[parseInt(nodeIndex.toString(), 10)].rotateAngle - this.buttonAngle };
                                newProp.selectedItems = { rotateAngle: newProp.selectedItems.rotateAngle };
                                oldProp.selectedItems = { rotateAngle: newProp.selectedItems.rotateAngle - this.buttonAngle };
                                if (this.fromUndo === false && _k === _l.length - 1) {
                                    this.buttonAngle = 1;
                                }
                            }
                            else if (this.buttonAngle || newProp.nodes[parseInt(nodeIndex.toString(), 10)].offsetX || newProp.nodes[parseInt(nodeIndex.toString(), 10)].offsetY) {
                                newProp = {};
                                oldProp = {};
                                this.buttonAngle = null;
                            }
                        }
                        if (_l.length > 1) {
                            this.buttonAngle = null;
        ...
        if (this.diagramActions & DiagramAction.Render) {
            ...
            if (!refereshColelction && (this.canLogChange()) && (this.modelChanged(newProp, oldProp))) {
                ...
                var connObjects = [];
                if (newProp.nodes && Object.keys(newProp.nodes).length > 0) {
                    for (var _m = 0, _o = Object.keys(newProp.nodes); _m < _o.length; _m++) {
                        var key_4 = _o[_m];
                        var nodeIndex_1 = parseInt(key_4);
                        nodeObjects.push(this.nodes[parseInt(nodeIndex_1.toString(), 10)].id);
                    }
                }
    ...
    */
    ...
    Diagram.prototype.initLayerObjects = function () {
        ...
        for (var _m = 0, _o = Object.keys(bpmnTable); _m < _o.length; _m++) {
            var obj = _o[_m];
            this.initObject(tempTabel["" + obj]);
            this.bpmnModule.updateDocks(tempTabel["" + obj], this);
        }
        var alignedGroups = this.alignGroup(groups, tempTabel);
        for (var _p = 0, alignedGroups_1 = alignedGroups; _p < alignedGroups_1.length; _p++) {
            var obj = alignedGroups_1[_p];
            var layer = this.commandHandler.getObjectLayer(obj);
            this.initNodes(tempTabel["" + obj], layer);
        }
        for (var _q = 0, connectors_1 = connectors; _q < connectors_1.length; _q++) {
            var connector = connectors_1[_q];
            var layer = this.commandHandler.getObjectLayer(connector.id);
            this.initConnectors(connector, layer);
        }
        if (isBlazor() && canCloneObject) {
            for (var _r = 0, _s = this.nodes; _r < _s.length; _r++) {
                var obj = _s[_r];
                updateNodeObject.push(cloneObject(obj, undefined, undefined, true));
            }
            for (var _t = 0, _u = this.connectors; _t < _u.length; _t++) {
                var obj = _u[_t];
                updateConnectorObject.push(cloneObject(obj, undefined, undefined, true));
            }
