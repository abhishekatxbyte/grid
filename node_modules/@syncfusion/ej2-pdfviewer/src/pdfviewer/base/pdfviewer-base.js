        ...
        if (this.pageCount > 0) {
            ...
            for (var i = 0; i < pageLimit; i++) {
                if (typeof pageValues.pageSizes[parseInt(i.toString(), 10)] !== 'object') {
                    ...
                    var size = { width: pageValues.pageSizes[parseInt(i.toString(), 10)].Width, height: pageValues.pageSizes[parseInt(i.toString(), 10)].Height, top: topValue, rotation: pageValues.pageRotation[parseInt(i.toString(), 10)] };
                    this.pageSize.push(size);
                }
